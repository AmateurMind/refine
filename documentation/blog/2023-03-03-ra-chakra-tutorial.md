...
It provides the [`useForm()`](https://refine.dev/core/templates/form/chakra-ui/useForm/) hook, which includes form validation and handles our form submission request to Strapi.
